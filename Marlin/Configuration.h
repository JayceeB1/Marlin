...
#define STRING_CONFIG_H_AUTHOR "(JC, BLV Cube SKR Turbo)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 416.41 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.128 // (mm) Distance from real junction edge
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 3, -2.98 }
...
#define Y_MAX_POS 335 //Y_BED_SIZE
